...
public class HotelRoomDetails extends JPanel implements ComponentListener
{
	private JLabel manufacturerLabel = new JLabel("Total Number Of Rooms:");
	private JLabel yearLabel = new JLabel("Single Bed Rooms:");
	private JLabel modelLabel = new JLabel("Double Bed Rooms:");
	private JLabel priceLabel = new JLabel("Booked Rooms:");
	private JLabel kmLabel = new JLabel("Available Rooms:");
	private JLabel infoLabel = new JLabel("Facialities:");
	...
	public void displayDetails(HotelRoom c)
	{
		...
		kmTextField.setText(c.getBookedRoom());
